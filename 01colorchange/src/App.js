...
function App() {
  ...
  return (
    ...
    <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 py-10">
    <div className="fixed flex flex-wrap justify-center shadow-lg gap-3 bg-white px-3 py-2 rounded-3xl">
